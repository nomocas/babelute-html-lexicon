...
var Babelute = require('babelute/lib/babelute'),
	...
	toSlugCase = require('to-slug-case'); // for data-* attributes
...
module.exports = Babelute.extendPragmatics(SimpleFacadePragmatics, {
	...
	style: function(tag, args /* name, value  */ ) {
	...
	data: function(tag, args) {
		var name = 'data-' + toSlugCase(args[0]),
			value = args[1],
	...
	onString: function(tag, args /* render */ , env) {
